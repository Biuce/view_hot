...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'partner_guang' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_GUANG', 'localhost'),
            'port' => env('DB_PORT_GUANG', '3306'),
            'database' => env('DB_DATABASE_GUANG', 'forge'),
            'username' => env('DB_USERNAME_GUANG', 'forge'),
            'password' => env('DB_PASSWORD_GUANG', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => 'think_',
            'strict' => false,
