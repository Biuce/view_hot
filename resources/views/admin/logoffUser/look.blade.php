                ...
                <div class="col-sm-12 text-sm-center">
                    @if($info['is_relation'] == 1)
                        <button class="btn btn-primary" type="submit" lay-submit lay-filter="formAdminUser"
                                id="submitBtn"
                                onclick="Cancel('{{ route('admin::cancel.cancel') }}', '{{ $info['id'] }}', 1)">{{trans('logoffUser.pass')}}</button>
                        <div style="display:inline;float:right;margin-right: 50px;">
                            <button class="btn btn-danger" type="submit" lay-submit lay-filter="formAdminUser"
                                    id="submitBtn"
                                    onclick="Cancel('{{ route('admin::cancel.cancel') }}', '{{ $info['id'] }}', 2)">{{trans('logoffUser.reject')}}</button>
                            @endif
