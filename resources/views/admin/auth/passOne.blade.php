                        ...
                        <div class="row row-30 justify-content-center align-items-center">
                            <div class="col-md-8 col-xl-5">
                                ...
                                <div class="row row-30 justify-content-center">
                                    <div class="col-xl-10">
                                        <form method="post" id="form" action="{{ route('admin::login.passVerify') }}">
                                            {{ csrf_field() }}
                                            <div class="alert alert-info alert-border-left" role="alert"><span
                                                        class="alert-icon fa-info"></span><span>{{trans('general.enter_account')}}</span>
                                            </div>
...
//                layer.msg(result.msg, {shift: 1}, function () {
                    ...
                    if (result.redirect) {
                        {{--console.log('{{ route('admin::login.passEmail') }}' + '?account=' + result.data.account);--}}
                        location.href = '{{ route('admin::login.passEmail') }}' + '?name=' + result.data.account;
                    }
//                });
            },
