    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <div style="margin-top: 20px;">
                <form name="admin_list_sea" class="form-search" method="get" action="{{ route('admin::log.index') }}">
                    {{--{{ csrf_field() }}--}}
                    <div class="row row-15">
                        <div class="col-sm-2">
                            <div class="input-group">
                                <input class="form-control" id="text" type="text" placeholder="{{trans('log.name')}}"
                                       name="name">
                            </div>
                        </div>
                        <div class="col-sm-2">
