                    ...
                    <div class="container-fluid">
                        <div class="row row-30 justify-content-center align-items-center">
                            <div class="col-md-8 col-xl-5">
                                <h3 class="text-center">{{trans('home.account_set')}}</h3>
                                <div class="row row-30 justify-content-center">
                                    <div class="col-xl-10">
                                        <form method="post" id="form" action="{{ route('admin::home.emailVerify') }}">
                                            {{ csrf_field() }}
                                            <div class="alert alert-info alert-border-left" role="alert"><span
                                                        class="alert-icon fa-info"></span><span>{{trans('home.tips')}}</span>
                                            </div>
                                            <div class="input-group mt-3">
                                                ...
                                                <input class="form-control" type="text" aria-describedby="icon-addon1"
                                                       name="email" placeholder="{{trans('home.enter_email')}}">
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                layer.msg(result.msg, {shift: 1}, function () {
                    ...
                    if (result.redirect) {
                        location.href = '{{ route('admin::home.code') }}';
                    }
                });
            },
