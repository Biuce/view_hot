                    ...
                    <div class="container-fluid">
                        <div class="row row-30 justify-content-center align-items-center">
                            <div class="col-md-8 col-xl-5">
                                <h3 class="text-center">{{trans('home.pass_set')}}</h3>
                                <div class="row row-30 justify-content-center">
                                    <div class="col-xl-10">
                                        <form method="post" id="form" action="{{ route('admin::home.verify') }}">
                                            {{ csrf_field() }}
                                            <div class="alert alert-info alert-border-left" role="alert"><span
                                                        class="alert-icon fa-info"></span><span>{{trans('home.pass_tips')}}</span>
                                            </div>
                                            <div class="input-group mt-3">
                                                ...
                                                <input class="form-control" type="password" name="password"
                                                       placeholder="{{trans('general.new_pass')}}" ria-label="Password"
                                                       aria-describedby="icon-addon1" id="password">
                                            </div>
                                            <div class="input-group mt-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="icon-addon1">
                                                ...
                                                <input class="form-control" type="password" name="password_confirmation"
                                                       placeholder="{{trans('general.new_pass_press')}}"
                                                       aria-label="Password" aria-describedby="icon-addon1"
                                            ...
                                            <div class="row row-10 align-items-center">
                                                <div class="col-sm-12 text-sm-center">
                                                    <button class="btn btn-primary" type="submit" lay-submit
                                                            ...
                                                            id="submitBtn">{{trans('general.submit')}}</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                layer.msg(result.msg, {shift: 1}, function () {
                    ...
                    if (result.redirect) {
                        location.href = '{{ route('admin::home.done') }}';
                    }
                });
            },
