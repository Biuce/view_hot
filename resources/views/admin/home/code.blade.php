                        ...
                        <div class="row row-30 justify-content-center align-items-center">
                            <div class="col-md-8 col-xl-5">
                                ...
                                <div class="row row-30 justify-content-center">
                                    <div class="col-xl-10">
                                        <form method="post" id="form" action="{{ route('admin::home.codeVerify') }}">
                                            {{ csrf_field() }}
                                            <div class="alert alert-info alert-border-left" role="alert"><span
                                                        class="alert-icon fa-info"></span><span>{{trans('home.content_1')}}{{ $email }}{{trans('home.content_2')}}</span>
                                            </div>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                layer.msg(result.msg, {shift: 1}, function () {
                    ...
                    if (result.redirect) {
                        location.href = '{{ route('admin::home.newPass') }}';
                    }
                });
            },
