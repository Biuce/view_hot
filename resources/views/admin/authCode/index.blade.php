    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <div style="margin-top: 20px;">
                <form name="admin_list_sea" class="form-search" method="get" action="{{ route('admin::code.index') }}">
                    {{ csrf_field() }}
                    <div class="row row-15">
                        ...
                        {{--<div class="col-sm-2">--}}
                            {{--<button class="btn btn-success" type="button" onclick="excel('{{ route('admin::code.export') }}')">{{trans('general.excel')}}</button>--}}
                        {{--</div>--}}
                    </div>
                </form>
            </div>
